  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center  mt-10 gap-5 bg-slate-100">
        <div>
          <h2 className="font-bold text-2xl text-black">Upgrade with Unlimited Plan</h2>
        </div>
        <div className={`flex md:flex-row flex-col gap-10`}>
          ...
          >
            <span className="text-black text-xl">Free</span>
            <h3 className="font-bold text-3xl text-black">0₹</h3>

            <ul className="flex flex-col gap-2">
              <li className="text-black">10,000 Words/Month</li>
              <li className="text-black">50+ content Templates</li>
              <li className="text-black">Unlimited copied & download </li>
              <li className="text-black">History show</li>
            </ul>
            {!user.active && (
          ...
          >
            <span className="text-xl text-black">Unlimited</span>
            <h3 className="font-bold text-3xl text-black">9₹ Only</h3>

            <ul className="flex flex-col gap-2">
              <li className="text-black">Unlimited words generates</li>
              <li className="text-black">50+ content Templates</li>
              <li className="text-black">Unlimited copied & download </li>
              <li className="text-black">History show</li>
            </ul>
            ...
            <button
              ...
              className={`  border border-blue-700  text-center py-3 px-5 rounded-3xl flex gap-3 ${
                user.active ? "bg-slate-700 text-white cursor-not-allowed":"bg-white text-black"
              }`}
            >
